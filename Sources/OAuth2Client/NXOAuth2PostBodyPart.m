...
- (id)initWithName:(NSString *)name content:(id)content;
{
    if ([content isKindOfClass:[NSString class]]) {
        ...
        NXOAuth2FileStreamWrapper *fsContent = (NXOAuth2FileStreamWrapper *)content;
        return [self initWithName:name streamContent:[fsContent stream] streamLength:[fsContent contentLength] fileName:[fsContent fileName] contentType:[fsContent contentType]];
    } else {
